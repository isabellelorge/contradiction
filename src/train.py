...
def main():
    ...
    parser.add_argument('--data_dir', default='/Users/isabellelorge/Desktop/who_you_like/debagreement_data/debagreement_google_drive', type=str, help='Data directory.')
    parser.add_argument('--trained_path', default='model.pth', type=str, help='Path for trained model.')
    parser.add_argument('--random_seed', default=123, type=int, help='Random seed.')
    parser.add_argument('--batch_size', default=16, type=int, help='Batch size.')
    parser.add_argument('--lr', default=0.000003, type=float, help='Learning rate.')
    ...
    parser.add_argument('--hidden_size', default=300, type=int, help='Size of hidden layer GCN.')
    parser.add_argument('--bert_path', default='bert-base-cased', type=str,  help='Path of BERT model.')
    parser.add_argument('--word2vec_path', default ='/Users/isabellelorge/Desktop/who_you_like/debagreement_data/debagreement_google_drive/word2vec_lem.model', type=str, help='Path of word2vec model.')
    parser.add_argument('--subreddit_sim', default=0.5, type=float, help='Entities similarity threshold subreddits.')
    parser.add_argument('--freq_threshold', default=5000, type=int, help='Frequency threshold entities.')
    ...
    with open('{}/train_pos_edges_nopunct.json'.format(args.data_dir), 'r') as f:
        train_pos_edges = json.load(f)
    with open('{}/train_neg_edges_nopunct.json'.format(args.data_dir), 'r') as f:
        train_neg_edges = json.load(f)

    with open('{}/dev_pos_edges_nopunct.json'.format(args.data_dir), 'r') as f:
        eval_pos_edges = json.load(f)
    with open('{}/dev_neg_edges_nopunct.json'.format(args.data_dir), 'r') as f:
